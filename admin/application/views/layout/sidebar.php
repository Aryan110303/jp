 ...
 <?php if ($this->rbac->hasPrivilege('student', 'can_view')) { ?>
                ...
                <?php $this->load->view('layout/top_sidemenu'); ?>
                    <ul class="sidebar-menu verttop">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('visitor_book', 'can_view')) {
                                            ...
                                            <li class="<?php echo set_Submenu('admin/visitors'); ?>"><a href="<?php echo base_url(); ?>admin/visitors"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('visitor_book'); ?></a></li>
                                             <li class="<?php echo set_Submenu('admin/holidays'); ?>"><a href="<?php echo base_url(); ?>admin/holidays"><i class="fa fa-angle-double-right"></i> Holidays Book</a></li>
                        ...
                        <li class="<?php echo set_Submenu('student/search'); ?>"><a href="<?php echo base_url(); ?>admin/Conference/gmeet"><i class="fa fa-angle-double-right"></i>Live Class</a></li>
...
<li class="<?php echo set_Submenu('student/uploadExamResult'); ?>"><a href="<?php echo base_url('student/uploadExamResult'); ?>"><i class="fa fa-angle-double-right"></i> Upload Marksheet</a></li>
                                           <?php
                                        }
...
<li class="<?php echo set_Submenu('student/classroom'); ?>"><a href="<?php echo base_url('student/classroom'); ?>"><i class="fa fa-angle-double-right"></i>Managae Class Room </a></li>
                                    </ul>
                                </li>
                                <?php
                            }
                        ...
                        //    print_r($userdata); die;
                           ...
                           if($uesrid==1){
                            if ($this->module_lib->hasActive('student_attendance')) {
                                ...
                                <li class="treeview <?php echo set_Topmenu('Online Exam');?>">
                                    <a href="#">
                                        <i class="fa fa-map-o"></i><span><?php echo "Online Exam"; ?></span> <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">                                        
                                            <li class="<?php echo set_Submenu('OnlineTest'); ?>"><a href="<?php echo base_url(); ?>OnlineTest"><i class="fa fa-angle-double-right"></i><?php echo "Online Exam List"; ?> </a></li>   
                                                                      
                                            <li class="<?php echo set_Submenu('OnlineTest/createexam'); ?>"><a href="<?php echo base_url(); ?>OnlineTest/createexam/"><i class="fa fa-angle-double-right"></i> Create Online Exam </a></li>
                                            
                                            <li class="<?php echo set_Submenu('OnlineTest/createexamquestions'); ?>"><a href="<?php echo base_url('OnlineTest/createexamquestions/'); ?>"><i class="fa fa-angle-double-right"></i>Add Questions</a></li>
                                            <li class="<?php echo set_Submenu('OnlineTest/result'); ?>"><a href="<?php echo base_url('OnlineTest/result/'); ?>"><i class="fa fa-angle-double-right"></i>Online Exam Result</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        <?php if ($this->rbac->hasPrivilege('class_timetable', 'can_view')) { ?>
                                            ...
                                            <li class="<?php echo set_Submenu('timetable/add_teachertt'); ?>"><a href="<?php echo base_url(); ?>admin/timetable/add_teachertt"><i class="fa fa-angle-double-right"></i>Add Teacher Timetable</a></li> 


                                             <li class="<?php echo set_Submenu('timetable/proxy_management'); ?>"><a href="<?php echo base_url(); ?>admin/Proxymanagment"><i class="fa fa-angle-double-right"></i>Teacher's Substitution Timetable</a></li>


                                            <li class="<?php echo set_Submenu('timetable/index2'); ?>"><a href="<?php echo base_url(); ?>admin/timetable/index2"><i class="fa fa-angle-double-right"></i> View Teacher's Timetable</a></li>

                                          

                                            <li class="<?php echo set_Submenu('timetable/index3'); ?>"><a href="<?php echo base_url(); ?>admin/timetable/index3"><i class="fa fa-angle-double-right"></i>View Class Timetable</a></li>
                            ...
                            if (($this->rbac->hasPrivilege('upload_content', 'can_view'))) {
                                ...
                                <li class="treeview <?php echo set_Topmenu('Download Center'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                       ...
                                       <li class="<?php echo set_Submenu('download/gatepass'); ?>"><a href="<?php echo base_url(); ?>Receive/"><i class="fa fa-angle-double-right"></i> Gate Pass</a></li>

                                       <li class="<?php echo set_Submenu('download/admitcard'); ?>"><a href="<?php echo base_url(); ?>Receive/admitcard"><i class="fa fa-angle-double-right"></i> Admit Card</a></li>

                                        <li class="<?php echo set_Submenu('download/marksheet'); ?>"><a href="<?php echo base_url(); ?>Marksheet"><i class="fa fa-angle-double-right"></i>MarkSheet</a></li>
                                         <li class="<?php echo set_Submenu('tc'); ?>"><a href="<?php echo base_url(); ?>Marksheet/transfer_certificate"><i class="fa fa-angle-double-right"></i>Transfer Certificate</a></li>
                             ...
                             $this->rbac->hasPrivilege('homework_report', 'can_view'))) {
                                ...
                                <li class="treeview <?php echo set_Topmenu('Homework'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <?php } ?>
                                       <li class="<?php echo set_Submenu('homework/complaint'); ?>"><a href="<?php echo base_url(); ?>complaint"><i class="fa fa-angle-double-right"></i> <?php echo 'Add Complaint'; ?></a></li>
                                        <li class="<?php echo set_Submenu('homework/complaint'); ?>"><a href="<?php echo base_url('admin/smslist/get_reports'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo 'SMS Reports'; ?></a></li>
                                    <li class="<?php echo set_Submenu('homework/complaint'); ?>"><a href="<?php echo base_url('admin/smslist/report'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo 'Search SMS Reports'; ?></a></li>
                               ...
                               $this->rbac->hasPrivilege('assign_vehicle', 'can_view'))) {
                                ...
                                <li class="treeview <?php echo set_Topmenu('Transport'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <?php } ?>
<!--                                            <li class="<?php echo set_Submenu('admin/route/studenttransportdetails'); ?>"><a href="<?php echo base_url(); ?>admin/transport_feetype"><i class="fa fa-angle-double-right"></i> <?php echo 'Transport Feetype'; ?></a></li>
                                            <li class="<?php echo set_Submenu('admin/route/studenttransportdetails'); ?>"><a href="<?php echo base_url(); ?>admin/transport_feemaster"><i class="fa fa-angle-double-right"></i> <?php echo 'Transport Fee Master'; ?></a></li>-->
                                            <li class="<?php echo set_Submenu('admin/route/studenttransportdetails'); ?>"><a href="<?php echo base_url(); ?>transportfee"><i class="fa fa-angle-double-right"></i> <?php echo 'Transport Fee Collection'; ?></a></li>
                                            <li class="<?php echo set_Submenu('admin/route/studenttransportdetails'); ?>"><a href="<?php echo base_url(); ?>transportfee/student_transport_fee"><i class="fa fa-angle-double-right"></i> <?php echo 'Transport Reports'; ?></a></li>
                               ...
                               $this->rbac->hasPrivilege('media_manager', 'can_view') ||
                                ...
                                <li class="treeview <?php echo set_Topmenu('Front CMS'); ?>">
                                    ...
                                    if ($this->rbac->hasPrivilege('media_manager', 'can_view')) {
                                        ...
                                        if ($this->rbac->hasPrivilege('banner_images', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/front/feature'); ?>"><a href="<?php echo base_url(); ?>admin/front/feature"><i class="fa fa-angle-double-right"></i> <?php echo "Courses"; ?></a></li>
                                            <?php
                                        }
                                        if ($this->rbac->hasPrivilege('banner_images', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/front/counters'); ?>"><a href="<?php echo base_url(); ?>admin/front/counters"><i class="fa fa-angle-double-right"></i> <?php echo "Counters"; ?></a></li>
                                            <?php
                                        }
                                        if ($this->rbac->hasPrivilege('banner_images', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/front/about'); ?>"><a href="<?php echo base_url(); ?>admin/front/about"><i class="fa fa-angle-double-right"></i> <?php echo "About"; ?></a></li>
                                            <?php
                                        }
                                         if ($this->rbac->hasPrivilege('banner_images', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/front/corpus'); ?>"><a href="<?php echo base_url(); ?>admin/front/corpus"><i class="fa fa-angle-double-right"></i> <?php echo "Corpus"; ?></a></li>
                                            <?php
                                        }
...
<?php
                                       ...
                                       <li class="<?php echo set_Submenu('studentfee/onlineTransactionReport'); ?>"><a href="<?php echo base_url(); ?>studentfee/onlineTransactionReport"><i class="fa fa-angle-double-right"></i> <?php echo "Online Transaction Report"; ?></a></li>
                                       <li class="<?php echo set_Submenu('studentfee/attemptOnlineTransaction'); ?>"><a href="<?php echo base_url(); ?>studentfee/attemptOnlineTransaction"><i class="fa fa-angle-double-right"></i> <?php echo "Attempt Transactions"; ?></a></li>
                        ...
                        ?>
                               ...
                               <!--  <li class="treeview <?php echo set_Topmenu('Other'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                            ...
                                            <li class="<?php echo set_Submenu('admin/summer_camp/index'); ?>"><a href="<?php echo base_url(); ?>admin/summer_camp"><i class="fa fa-angle-double-right"></i> summer Camp</a></li>
                                           
                                           <li class="<?php echo set_Submenu('admin/front_registration/index'); ?>"><a href="<?php echo base_url(); ?>admin/front_registration"><i class="fa fa-angle-double-right"></i> Front Registration</a></li>
                                           
                                        
                                           <li class="<?php echo set_Submenu('admin/activity/index'); ?>"><a href="<?php echo base_url(); ?>admin/activity/index"><i class="fa fa-angle-double-right"></i> Media</a></li>
                                ...
                                <li class="treeview <?php echo set_Topmenu('classroom'); ?>">
                                    <a href="#">
                                        <i class="fa fa-gears"></i> <span>Manage ClassRoom</span> <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">
                                        
                                            <li class="<?php echo set_Submenu('student/classroom'); ?>"><a href="<?php echo base_url(); ?>admin/Conference/gmeet"><i class="fa fa-angle-double-right"></i> List Class Room</a></li>
                                            <?php
                                             $userdata= $this->session->userdata('admin');
                                             //    print_r($userdata); die;
                                                 $uesrid=$userdata['id']; 
                                                 if($uesrid==1){ ?>
                                            <li class="<?php echo set_Submenu('student/createclassroom'); ?>"><a href="<?php echo base_url(); ?>student/createclassroom"><i class="fa fa-angle-double-right"></i> Create Class Room</a></li>
