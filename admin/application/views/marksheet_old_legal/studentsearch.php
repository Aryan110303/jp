                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('marksheet') ?>" method="post" class="">
                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('marksheet/viewmarksheet/').$student['id'] ?>"><?php echo $student['firstname'] . " " . $student['lastname']; ?>
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td><a href="<?php echo base_url('marksheet/viewmarksheet/').$student['id'] ?>"><i style="color: orange;" class="fa fa-2x fa-calendar"></i></a></td>
