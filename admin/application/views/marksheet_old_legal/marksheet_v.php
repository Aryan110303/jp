            ...
            <tr>
                ...
                <td style="float: right">
                    <table style=" text-align: left;">
                        ...
                        <tr><td  style="font-weight: bold">  Date of Birth : <?php                                                     
    ...
    <tr>
        <td style="width:200px;" rowspan="3">
         ...
         <td style="width:300px; border: 1px solid;">
             <table width="100%" class="boldfont" border="1" >
                <tr>
...
$val = ($val2*100)/$obt_full[$i] ; 
$valtotal[] = $val ;
                                                                                               
                                         ?><tr>
                                        <td> <?= round($val,1)  ?></td> </tr>
                                        <?php   $i++ ; }?>
  ...
  <table width="100%">
    <tr>
          ...
          <td style="width:300px;">
            <table border="1" class="boldfont">
                    ...
                    <tr>
                      ...
                      <td colspan="2"><?php echo  round((array_sum($tot_qtr_get)*100 )/array_sum($tot_qtr_full) ,1 ); ?>  %</td>
                      <td colspan="2"><?php echo  round((array_sum($tot_half_get)*100 )/array_sum($tot_half_full) ,1 ); ?>  %</td>
                      <td colspan="2"><?php echo  round((array_sum($tot_final_get)*100 )/array_sum($tot_final_full) ,1 ); ?>  %</td>
          ...
          <td style="width:200px;">
            <table border="1" class="boldfont">
                    <tr>
                      <td><?php  echo  array_sum($obt_full ) ;  ?></td> 
                      <td><?php  echo  array_sum($obt_get ) ;  ?></td>
                      <td><?php  echo $i*100 ; ?></td>
                      <td> <?php echo  round(array_sum($valtotal) ,1);  ?></td>
                    </tr>
                    <tr  >
                         <td colspan="4"  style="height: 50px;"> 
                                       <?php $totlpercnt =  round(((array_sum($obt_get))*100)/array_sum($obt_full),1); 
                                         echo $totlpercnt;  ?> %
                         </td>
                    </tr>
           ...
           <td style="float: left;">&nbsp; </td>
            <td style="text-align: center; "> 
             <table width="300px ;" border="1" >
                ...
                (On a 5 point grading scale : A-E)</td><td style="padding:0px !important;"><b>GRADE</b></td>  <td> OverALL Grade</td> </tr>
                <tr><td  style="padding:0px !important;">Drawing</td><td style="padding:0px !important;"><?php echo  $grade->drawing ?></td>
                    <td rowspan="6"><b><?php if ($totlpercnt >= 91 ) {
                      echo "A1" ;
                    } elseif ($totlpercnt >=81 ) {
                      echo "A2" ;
                    }elseif ($totlpercnt >=71 ) {
                      echo "B1" ;
                    }elseif ($totlpercnt >=61 ) {
                      echo "B2" ;
                    }elseif ($totlpercnt >=51 ) {
                      echo "C1" ;
                    }elseif ($totlpercnt >=41 ) {
                      echo "C2" ;
                    }elseif ($totlpercnt >=33 ) {
                      echo "D" ;
                    }else{
                      echo "E (Needs Improvement)" ;
                    }
                ...
                <tr><td style="padding:0px !important;">Courteousness</td><td style="padding:0px !important;"><?php  echo $grade->courteousness ?></td></tr>
                <tr><td style="padding:0px !important;">Obedience</td><td style="padding:0px !important;"><?php  echo $grade->obedience ?></td></tr>
                <tr><td style="padding:0px !important;">Discipline</td><td style="padding:0px !important;"><?php  echo $grade->discipline ?></td></tr>
