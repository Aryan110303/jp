                        ...
                        <form action="<?php echo site_url("admin/feetype/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('fine'); ?> Apply</label>
                                 <input id="fine_apply" name="fine_apply" type="checkbox" class="checkbox" zoom=".5em"  <?php if($feetype['fine_apply'] == 1 ) echo "checked";?> value="1" />
