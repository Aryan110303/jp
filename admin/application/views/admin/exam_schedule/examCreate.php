                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group"> <input onclick="remove(this.id);" type="checkbox" value="1" name="yesorno<?php echo $value['id'] ?>" id='<?php echo $value['id'] ;?>' checked> </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="date_<?php echo $value['id'] ?>" class="form-control sandbox-container date_<?php echo $value['id'] ?>" id="date_<?php echo $value['id'] ?>" placeholder="Enter date" value="<?php echo $exam_date; ?>">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="fmark_<?php echo $value['id'] ?>" class="form-control fmark_<?php echo $value['id'] ?>" id="fmark_<?php echo $value['id'] ?>" value="<?php echo $value['full_marks'] ?>" placeholder="Enter Full Marks">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">

                                                            <input type="text" name="pmarks_<?php echo $value['id'] ?>" class="form-control pmarks_<?php echo $value['id'] ?>" id="pmarks_<?php echo $value['id'] ?>" value="<?php echo $value['passing_marks'] ?>" placeholder="Enter Passing Marks">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php
        ...
        ?>";
            $.ajax({
                ...
                success: function (data) {
                    // alert(data[0].class_id)
                    //if (data[0].class_id != 38 && data[0].class_id != 39) {
                    if (class_id != 38 && class_id != 39) {
                        $.each(data, function (i=0, obj)
                        {
                            if (i==0) {
                                div_data += "<option value=" + obj.section_id + ">Select all</option>";
                            }   
                        });
                    }else{
                        ...
                        if (data[0].class_id != 38 && data[0].class_id != 39) {
                            $.each(data, function (i=0, obj)
                            {
                                if (i==0) {
                                    ...
                                    // div_data += "<option value=" + obj.section_id + ">Select all</option>";
                                    div_data += "<option value=" + obj.section_id + " " + sel + ">Select all</option>";
                                }
...
<script>
  function remove(val) {    
    //alert('#date_'+val);
     $('#date_'+val).rules('remove', 'required');
     $('#date_'+val).removeAttr('required');

     $('#pmarks_'+val).rules('remove', 'required');
     $('#pmarks_'+val).removeAttr('required');

     $('#fmark_'+val).rules('remove', 'required');
     $('#fmark_'+val).removeAttr('required');            
        }
</script> 