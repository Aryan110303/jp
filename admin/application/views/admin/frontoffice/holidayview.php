<div class="content-wrapper" style="min-height: 348px;">  
    ...
    <section class="content">
        <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add'); ?> Holidays</h3>
                        </div><!-- /.box-header -->
                        <?php //echo $this->session->flashdata('msg')  ?>
                        <form id="form1" action="<?php echo site_url('admin/holidays') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
            ...
            ?>">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="download_label">Holidays <?php echo $this->lang->line('list'); ?></div>
        ...
        <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_delete')) { ?>
                                                            ...
                                                            <a href="<?php echo base_url(); ?>admin/holidays/delete/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="Delete">
