                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group" hidden="" id="templategroupDiv" class="templateDiv">
                                                    <label for="pwd">Select Template</label>
                                                    <select class="form-control" name="template" id="template" onchange="getTemplateByGroup(this.value)">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="group_msg_text" name="group_message" class="form-control" rows="5">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group" hidden="" id="templateperticularDiv" class="templateDiv">
                                                    <label for="pwd">Select Template</label>
                                                    <select class="form-control" name="template" id="template" onchange="getTemplateByIndivitual(this.value)">
                                                        <option>Select Template</option>
                                                        <?php
                                                           foreach ($templateList as $smsList) {
                                                                 echo "<option value=".$smsList->template_id.">" .$smsList->template_name. "</option>";
                                                ...
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('message'); ?></label><small class="req"> *</small>
                                                    <textarea id="individual_msg_text" name="individual_message" class="form-control" rows="5">
                                                        <?php echo set_value('message'); ?>
                                                    </textarea>
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group" hidden="" id="templateclassDiv" class="templateDiv">
                                                    <label for="pwd">Select Template</label>
                                                    <select class="form-control" name="template" id="template" onchange="getTemplateByClass(this.value)">
                                                        <option>Select Template</option>
                                                        <?php
                                                           foreach ($templateList as $smsList) {
                                                                 echo "<option value=".$smsList->template_id.">" .$smsList->template_name. "</option>";
                                                ...
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('message'); ?></label><small class="req"> *</small>
                                                    <textarea id="class_msg_text" name="class_message" class="form-control" rows="5">
                                                        <?php echo set_value('message'); ?>
                                                    </textarea>
                            ...
                            setTimeout(function () {
                                ...
                                $.each(data, function (i, obj)
                                {
                                    if (category_selected == "student") {
                                        ...
                                        var name = obj.firstname + " " + obj.lastname + "(" + obj.admission_no + ", class - "+obj.class+"("+obj.section+"))";
...
<script type="text/javascript">
    $('input[name="group_send_by[]"]').change(function(event) {
        // alert(this.value)
          // State has changed to checked/unchecked.
          if ((this.value == "sms")) {
            if ($(this).is(':checked')){
                $("#templategroupDiv").show();
            }else{
                $("#templategroupDiv").hide();
            }             
          }else{
            $("#templategroupDiv").hide();
          }
    });
    $('input[name="individual_send_by[]"]').change(function(event) {
        // alert(this.value)
          // State has changed to checked/unchecked.
          if ((this.value == "sms")) {
            if ($(this).is(':checked')){
                $("#templateperticularDiv").show();
            }else{
                $("#templateperticularDiv").hide();
            }             
          }else{
            $("#templateperticularDiv").hide();
          }
    });
    $('input[name="class_send_by[]"]').change(function(event) {
        // alert(this.value)
          // State has changed to checked/unchecked.
          if ((this.value == "sms")) {
            if ($(this).is(':checked')){
                $("#templateclassDiv").show();
            }else{
...
<script type="text/javascript">
    function getTemplateByClass(id) {
        // body...
        $.ajax({
            ...
            success: function (res)
            {
                ...
                if (res) {
                    $("#class_msg_text").text(res.template_msg);
    ...
    function getTemplateByGroup(id) {
        // body...
        $.ajax({
            url: "<?php echo site_url("homework/getTemplateMsg/") ?>" + id,
            type: "POST",
            ...
            success: function (res)
            {
                // alert(res.template_msg)
                if (res) {
                    $("#group_msg_text").text(res.template_msg);
                    // $('iframe').contents().find('.wysihtml5-editor').html(res.template_msg);
                }else{
                    $("#group_msg_text").text('');
                    // $('iframe').contents().find('.wysihtml5-editor').html('');
    ...
    function getTemplateByIndivitual(id) {
        // body...
        $.ajax({
            url: "<?php echo site_url("homework/getTemplateMsg/") ?>" + id,
            type: "POST",
            ...
            success: function (res)
            {
                // alert(res.template_msg)
                if (res) {
                    $("#individual_msg_text").text(res.template_msg);
                    // $('iframe').contents().find('.wysihtml5-editor').html(res.template_msg);
                }else{
                    $("#individual_msg_text").text('');
                    // $('iframe').contents().find('.wysihtml5-editor').html('');
                }
            }
        });
