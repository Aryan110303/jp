                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="group_msg_text" name="group_message" class="form-control" rows="6"><?php echo set_value('message'); ?></textarea>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('message'); ?></label><small class="req"> *</small>
                                                <textarea  id="individual_msg_text" name="individual_message" class="form-control" rows="6"><?php echo set_value('message'); ?></textarea>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('message'); ?></label><small class="req"> *</small>
                                                <textarea id="class_msg_text" name="class_message" class="form-control" rows="6"><?php echo set_value('message'); ?></textarea>
