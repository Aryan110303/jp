...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form id="form1" action="<?php echo site_url('admin/front/corpus/edit/' . $result['id']) ?>" enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="col-md-9">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_feature'); ?></h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <span class="text-danger"><?php echo form_error('title'); ?></span>
                                 ...
                                 <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo 'Link'; ?></label><small class="req"> *</small>
                                <input id="link" name="link" placeholder="Full URL for link" type="text" class="form-control"  value="<?php echo set_value('link', $result['link']); ?>" />
                ...
                <div class="col-md-3 col-sm-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('image'); ?></h3>
                            <div class="box-tools pull-right">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-sm">
                                    <input class="form-control iframe-btn" placeholder="<?php echo $this->lang->line('select_image'); ?>" type="text" name="image" id="image" value="<?php echo $result['image']; ?>">
                                ...
                                <div id="image_preview" class="thumbnail" style="margin-top: 10px; <?php echo $image_display; ?>">
                                    <img src="<?php echo $result['image']; ?>" class="img-responsive feature_image_url" >
                                </div>
                            </div>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
