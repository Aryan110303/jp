                                                ...
                                                <tr id="<?php echo $page["id"]; ?>">
                                                    ...
                                                    <td class="mailbox-date pull-right no-print">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('gallery', 'can_edit')) {
                                                            ?>
                                                            <a href="<?php echo site_url('admin/front/gallery/edit/' . $page['id']); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('gallery', 'can_delete')) {
                                                            ?>
                                                            <a href="<?php echo site_url('admin/front/gallery/delete/' . $page['id']); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
