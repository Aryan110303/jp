...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form id="form1" action="<?php echo site_url('admin/front/counters/edit/' . $result['id']) ?>" enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="col-md-6">
                    <!-- Horizontal Form -->
                        ...
                        <div class="box-body">
                           ...
                           <!--  <div class="dividerhr"></div> -->
                            ...
                            <div class="form-group">
                                ...
                                <input id="counter" name="counter" placeholder="" type="text" class="form-control"  value="<?php echo set_value('counter', $result['counter']); ?>" />
