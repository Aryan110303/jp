...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form id="form1" action="<?php echo site_url('admin/front/feature/edit/' . $result['id']) ?>" enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="col-md-9">
                    <!-- Horizontal Form -->
                ...
                <div class="col-md-3 col-sm-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('icon'); ?></h3>
                            <div class="box-tools pull-right">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-sm">
                                    <input class="form-control iframe-btn" placeholder="<?php echo $this->lang->line('select_image'); ?>" type="text" name="icon" id="image" value="<?php echo $result['icon']; ?>">
                                ...
                                <div id="image_preview" class="thumbnail" style="margin-top: 10px; <?php echo $image_display; ?>">
                                    <img src="<?php echo $result['icon']; ?>" class="img-responsive feature_image_url" >
                                </div>
                            </div>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
