                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/front/menus/edititem/' . $result['slug'] . "/" . $top_menu) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="material-switch">
                                    <input id="sub_menu" name="sub_menu" type="checkbox" class="sub_menu_chk"  value="1"  />
                                    <label for="sub_menu" class="label-success"></label>
                                </div>
                            </div>
                           ...
                           if($result['p_menu_id']){?>
                               ...
                               <div class="form-group " id="parent_m" style="">
                                <label for="exampleInputEmail">Main Menu</label>
                                <select name="p_menu_id" id="p_menu_id" class="form-control">
                                    <option value="">Select Menu</option>
                                    <?php  foreach ($main_menu as $key => $value) {?>
                                      
                                        <option value="<?php echo $value->id ?>"<?php if($result['p_menu_id']==$value->id){ echo 'selected';}?>  ><?php echo $value->menu ?></option>
                       ...
                       <?php  }else{?>
                              ...
                              <div class="form-group " id="parent_m" style="display:none">
