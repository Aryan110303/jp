...
//                                                                        die;
                                ...
                                <div class="form-group">
                                    ...
                                    foreach ($routelist as $route) {
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="route[]" value="<?php echo $route['id'] ?>" <?php echo set_checkbox('route[]', $route['id'], check_in_array($route['id'], $vehroute[0]->vehicles)); ?> ><?php echo $route['route_title'] ?>
                                            </label>
                                        </div>
                                        <?php
                                    }
                                    ?>
                                    <span class="text-danger"><?php echo form_error('route[]'); ?></span>
                                </div>
