                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="due_date" name="due_date" placeholder="" type="text" class="form-control"  value="<?php echo set_value('due_date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($feegroup_type->due_date))); ?>"  />
                                            <span class="text-danger"><?php echo form_error('due_date'); ?></span>
                                        </div>                                        
                                          <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('amount'); ?> ReAdmission</label><small class="req"> *</small>
                                            <input id="amount" name="amount" placeholder="" type="text" class="form-control"  value="<?php echo $feegroup_type->amount; ?>" />
                                            <span class="text-danger"><?php echo form_error('amount'); ?></span>
                                        </div>
                                         <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('amount'); ?> New Admission</label><small class="req"> *</small>
                                            <input id="amount2" name="amount2" placeholder="" type="text" class="form-control"  value="<?php echo $feegroup_type->amount_II; ?>" />
                                            <span class="text-danger"><?php echo form_error('amount2'); ?></span>
                                        </div>
                                          <div class="form-group">
                                            <label for="exampleInputEmail1">Default Fee </label><small class="req"> (If select Yes)*</small>
                                              <select class="form-control" name="default" id="default" >
                                                  <option <?php if($feegroup_type->fee_bydefault == 0){ echo  "selected";} ?> value="0">No</option>
                                                  <option <?php  if($feegroup_type->fee_bydefault == 1){ echo  "selected";} ?> value="1">Yes</option>
                                              </select>
                                            <span class="text-danger"><?php echo form_error('default'); ?></span>
                                        </div>
                                         <div class="form-group">
                                            <label for="exampleInputEmail1">Is Shown Tag </label><small class="req"> (If select Yes)*</small>
                                              <select class="form-control" name="shows" id="shows" >
                                                  <option <?php if($feegroup_type->shows == 0){ echo  "selected";} ?> value="0">No</option>
                                                  <option <?php  if($feegroup_type->shows == 1){ echo  "selected";} ?> value="1">Yes</option>
                                              </select>
                                            <span class="text-danger"><?php echo form_error('shows'); ?></span>
                                        </div>
