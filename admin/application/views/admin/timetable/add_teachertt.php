...
<table class=" table table-responsive ">
    ...
    <tbody>
        <tr>
            ...
            <td><input type="time" name="timefrom1"><input type="time" name="timeto1"></td>
            <td><input type="time" name="timefrom2"><input type="time" name="timeto2"></td>
            <td><input type="time" name="timefrom3"><input type="time" name="timeto3"></td>
            <td><input type="time" name="timefrom4"><input type="time" name="timeto4"></td>
            <td><input type="time" name="timefrom5"><input type="time" name="timeto5"></td>
            <td><input type="time" name="timefrom6"><input type="time" name="timeto6"></td>
            <td><input type="time" name="timefrom7"><input type="time" name="timeto7"></td>
            <td><input type="time" name="timefrom8"><input type="time" name="timeto8"></td>
