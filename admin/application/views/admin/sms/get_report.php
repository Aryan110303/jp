                                    ...
                                    <table class="table table-striped table-bordered table-hover example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text text-left wid">Message</th>
                                                <th class="text text-left">Class</th>
                                                <th class="text text-left">Section</th>
                                                <th class="text text-left">Created Date</th>
                                                <th class="text text-left"> Delivered Date</th>
                                                <th class="text text-center">Status</th>
                                                <th class="text text-left">View </th>
                                        ...
                                        <tbody>
                                              ...
                                              //  print_r($result); die;
                                                foreach ($result as $value) { 
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td class="wid"><?php echo $value->title; ?> </td>
                                                                <td><?php echo $value->message; ?> </td>

                                                                <td class="text text-center">

                                                                    <?php if ($value->class_id == 0) {
                                                                       echo '-' ;
                                                                    }else{

                                                                    echo $this->classteacher_model->findfield('classes','id', $value->class_id ,'class'); 
                                                                    }
                                                                 ?> 
                                                                 ...
                                                                 if ( $value->section_id  == 0) {
                                                                    ...
                                                                    echo $this->classteacher_model->findfield('sections','id',$value->section_id,'section');
                                                                 }
                                                                 ?> </td>
                                                               ...
                                                               <!--   <td><?php echo $value->created_at; ?> </td> -->
                                                                  <td><?php if ($value->updated_at = '0000-00-00 00:00:00') {
                                                                      echo 
                                                                      '--' ;
                                                                  } else{ 
                                                                    echo $value->updated_at; }?> </td>
                                                                ...
                                                                <td class="text text-center" ><a href="<?= base_url('admin/Smslist/msgreport/').$value->id ?>"><i class="fa fa-eye"></i></a></td>
