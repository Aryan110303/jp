        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="row">
                     <div class="col-md-6">                                
                         <form role="form" action="<?php echo site_url('admin/smslist/report')?>" method="post" class="">
                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a href="<?php echo base_url('admin/Smslist/all_message').'/'.$student['mobileno'] ; ?>"><i class="fa fa-eye"></i></a></td>
                                              </tr>
                                                </tr>
                                                <?php
                                                $count++;
