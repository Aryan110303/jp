                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url("admin/timetable/edit_teachertt");?>" method="POST">
                                  ...
                                  <div class="form-group col-md-4" >
                                        <label for="exampleInputEmail1">Edit <?php echo $this->lang->line('teacher'); ?>'s Time Table</label>
                     ...
                     <form action="<?php echo site_url('admin/timetable/add_teachertt') ?>"  method="post" accept-charset="utf-8" name="add">
                        ...
                        <div class="box-body"> 
                            <div class="form-group col-md-4" >
                                        <label for="exampleInputEmail1"> New <?php echo $this->lang->line('teacher'); ?> Time Table</label>
                                       <select  id="teacher_id" name="teacher_id" class="form-control" >
                                            <option value="0"><?php echo $this->lang->line('select'); ?></option>
                                            <?php
                                            foreach ($teachers as $teacher) {
