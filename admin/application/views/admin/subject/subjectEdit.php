                    ...
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url("admin/subject/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" value="Written" name="type"  <?php if (set_value('type', $subject['type']) == "Written") echo "checked"; ?> checked>Written
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="type" <?php if (set_value('type', $subject['type']) == "Oral") echo "checked"; ?> value="Oral">Oral
                                </label>
                                ...
                                <div class="form-group"><br>
                                    ...
                                    foreach ($subjectlist as $subjects) { ?>
                                        <option <?php if($subjects['id'] == $subject['parent']) echo "selected" ;?>  value="<?php echo $subjects['id']?>"><?php echo $subjects['name']?></option>
                                    <?php } ?>
                                    </select>  
