                        ...
                        <form id="form1" action="<?php echo site_url('admin/subject/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" value="Written" name="type"  <?php if (set_value('type') == "Written") echo "checked"; ?> checked><?php echo 'Written'; ?>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="type" <?php if (set_value('type') == "Oral") echo "checked"; ?> value="Oral"><?php echo 'Oral'; ?>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" value="Theory" name="type"  <?php if (set_value('type') == "Theory") echo "checked"; ?> checked><?php echo 'Theory'; ?>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="type" <?php if (set_value('type') == "Practical") echo "checked"; ?> value="Practical"><?php echo 'Practical'; ?>
                                </label>
                                ...
                                <tbody>
                                    ...
                                    foreach ($subjectlist as $subject) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><?php echo $subject['parent']; ?></td>
