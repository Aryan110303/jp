                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                         ...
                                         <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Group"; ?></label>
                                                <select id="group" name="group" placeholder="" type="text" class="form-control" >
                                                    <option value="select"><?php echo $this->lang->line('select') ?></option>
                                                    <?php $group = $this->db->query("SELECT * from teachers_group where 1")->result_array();
...
<script>
  function get_client_val(vehicle) {
        if(vehicle != '')
            $.ajax({
                url: '<?php echo base_url(); ?>admin/staff/get_route/' + vehicle,
