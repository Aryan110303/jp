                                                ...
                                                foreach ($resultlist as $student) {
                                                    ...
                                                    <tr>
                                                        <td class="text-center">
                                                            <input type="checkbox"  class="checkbox center-block" data-student_id="<?php echo $student['id'] ?>"   name="check" id="<?php echo $student['id'] ?>" value="<?php echo $student['id'] ?>">
                                                        ...
                                                        <td><button class="btn btn-info btn-sm printSelected pull-right" type="button" name="generate" title="generate IdCard " onclick="checkkaro(<?php echo $student['id'] ?>)" ><?php echo 'Print '; ?></button></td>
