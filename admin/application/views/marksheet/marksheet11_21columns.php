...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  *{margin:0; padding: 0;}
  ...
  .table td{border: 1px solid #333; padding: 16px 10px;}
  .table2{border-collapse: collapse;}
  .table2 td{border: 1px solid #333; padding: 16px 0px;}

  .table3{border-collapse: collapse;}
  .table3 td{border: 1px solid #333; padding: 16px 0px;}

</style>
</head>
<body>

 <div style="width:1000px; margin:0px auto; position: relative; z-index: 1;
      ...
      <table width="100%" cellpadding="0" cellspacing="0" class="table" style="text-align: center;">
        ...
        foreach ($subject as $key => $sub) { ?>
         ...
         <?php } ?>
            ...
            <tr style="background: #f7921e;color: #fff;" >
                 <td valign="top" style="text-align: left; color: #fff;font-weight: bold;">
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Attendance : </td>
