    ...
    <td valign="top">
      <table width="100%" cellpadding="0" cellspacing="0" class="table" style="text-align: center;">
          ...
          <tr>
            ...
            <td valign="middle"><?php echo 0; ?></td>
            <td valign="middle"><?php echo 0; ?></td>
            <td valign="middle"><?php echo 0; ?></td>
            <td valign="middle"><?php echo 0; ?></td>
          </tr>
    ...
    <td valign="top" style="font-weight: bold;">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td valign="top" style="width: 30%; padding-left: 6px;">
            <table width="100%" cellpadding="0" cellspacing="0" class="table" style="background: #f7921e;color: #fff;">
              <tr>
                <td>500</td><td>350</td>
                <td>740</td><td>490</td>
              ...
              <tr>
                ...
                <td colspan="2" style="text-align: center;">66.2%</td>
                <td colspan="2" style="text-align: center;">NAN%</td>
              </tr>
              <tr><td colspan="6" >&nbsp;</td></tr>
            </table>
          </td>
          <td valign="top" style="width: 30%; padding-left: 6px;" align="right">
            <table width="100%" cellpadding="0" cellspacing="0" class="table" style="background: #f7921e;color: #fff;">
              <tr>
                <td></td> 
                <td></td>
              ...
              <tr><td colspan="4" style="height: 56px; text-align: center; font-weight: bold;">NAN%</td></tr>
            </table>
          </td>
        </tr>
      </table>
