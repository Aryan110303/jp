...
<table cellpadding="0" cellspacing="0" width="100%" align="center" style="background-image:<?php echo base_url().'/uploads/logo.png' ;?>">
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
         <tr>
          <td valign="top" align="left"><img src="<?php echo base_url().'/uploads/logo.png' ;?>" width="90" height="110" /></td>
           <td valign="top" style="font-weight: bold;font-size: 25px;text-align: center; padding-top: 40px; padding-bottom: 15px; line-height: normal;">Central Academy Senior Secondary School <span style="font-weight: lighter;  font-size: 18px; " > (10+2)</span></td>
          <td valign="top" align="right" > <table>
            <tr><td valign="top" height="20"></td></tr>
            <tr>
              <td style="border:2px solid #000; height:70px; width:45px; ">
                &nbsp;
              </td>
            </tr>
          </table></td>
  ...
  <tr><td valign="top" height="5"></td></tr> 
   ...
   <tr>
    <td valign="top" style="text-align: center; font-size: 14px;padding-bottom: 2px;">Mathura Vihar, Vijay Nagar, Jabalpur - 482002 (M.P.)</td>
    </tr>
    <tr>
      <td valign="top" style="text-align: center; font-size: 14px;padding-top: 3px;"><span style="padding-left: 10px;">Phone:</span> 0761-4928811</td>
    </tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
             ...
             <td valign="top" align="left" width="140">
              <img src="<?php echo 'http://softwares.centralacademyjabalpur.com/'.$student['image'] ; ?>" style="height: 120px;border: 2px solid #000; border-radius: 10px;" />
            </td>
            <td valign="top">
              <table width="100%" cellpadding="0" cellspacing="0" class="">
                <tr>
                  <td valign="top" style="font-weight: bold; padding-top: 20px; padding-bottom: 5px">Scholar No.: <?php echo $student['admission_no'] ; ?></td>
                </tr>
                <tr>  
