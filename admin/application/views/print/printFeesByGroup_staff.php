                    ...
                    <div class="invoice">
                        ...
                        <div class="row">                           
                            <div class="col-xs-6">
                                <br/>
                                <address>
                                    <strong><?php echo $feeList->name . " " . $feeList->surname; ?></strong><br>
                                ...
                                <table class="table table-striped table-responsive" style="font-size: 8pt;">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty($feeList)) {
                                            ...
                                            $feetype_balance = $feeList->fees_amount - ($fee_paid + $fee_discount);
                                            ?>
                                            <tr  class="dark-gray">

                                                <td><?php
                                                    echo $feeList->route_title;
                                                    ?></td>
                                                ...
                                                <td class="">
                                                    ...
                                                    if ($feeList->due_date == "0000-00-00") {
                                                        ...
                                                        echo date($this->customlib->getSchoolDateFormat(), strtotime($feeList->due_date));
                                                    }
                                                    ?>
                                                </td>
                                                <td class="">
                                                ...
                                                <td class="text text-right"><?php echo $currency_symbol . $feeList->fees_amount; ?></td>
