                            ...
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td><strong><?php echo 'Fine Amount'; ?></strong></td>
                                        <td class="mailbox-name"> <?php echo $settinglist[0]['fine_amount'] ?></td>
                                    </tr>
                ...
                <div class="row">
                    <form role="form" id="schsetting_form" action="<?php echo site_url('schsettings/ajaxedit') ?>">
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                         ...
                         <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label for="exampleInputEmail1"><?php echo 'Fine Amount'; ?></label><small class="req"> *</small>
    ...
    $('.edit_setting').on('click', function (e) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('input[name="fee_due_days"]').val(result.fee_due_days);//fine_amount
                $('input[name="fine_amount"]').val(result.fine_amount);//
