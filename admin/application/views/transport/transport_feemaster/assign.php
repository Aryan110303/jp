...
<div class="content-wrapper" style="min-height: 946px;">   
    <section class="content-header">
        <h1>
            ...
            <i class="fa fa-money"></i> Transport Fees collection</h1>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/transport_feemaster/assign/' . $id) ?>" method="post" class="form-horizontal">
                ...
                <form method="post" action="<?php echo site_url('transportfee/addfeegroup') ?>" id="assign_form">
