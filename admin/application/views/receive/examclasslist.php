                                ...
                                <table class="table table-hover table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text text-center"> AdmitCard</th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($classsectionList as $clssection) {
                                             $class_id = $clssection['class_id'] ; 
                                             $section_id = $clssection['section_id'] ;
                                            ?>
                                            <tr>
                                                ...
                                                <td  class="text text-center">
                                                    ...
                                                    <!--   <center> <i class="fa fa-calendar-times-o"></i>  <a href="<?php echo base_url('receive/studentadmitcard')?> "> View Schedule</a>
                                                    </center> --><br>
                                                </td>
                                                <td >  
                                                    <?php $examid = $this->uri->segment(3) ;?>
                                                   <center> <i class="fa fa-calendar-times-o"></i>  <a href="<?php echo base_url('receive/studentadmitcard').'/'.$examid.'/'.$clssection['class_id'].'/'.$clssection['section_id'] ?> "> Download here</a> </center>
                                                    </td>
