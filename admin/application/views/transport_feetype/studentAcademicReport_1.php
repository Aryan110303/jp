                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text text-left"><?php echo $this->lang->line('roll_no'); ?></th>
                                                 <th class="text text-center"><?php echo 'Month'; ?></th>
                                                    ...
                                                    <tr>
                                                        <td><?php echo $value->firstname . ' ' . $value->lastname; ?> </td>
                                                                ...
                                                                <td><?php echo $value->roll_no; ?> </td>
                                                                  <td class="text text-center"><?php $date =  $value->date;
                                                                 echo date("F", strtotime($value->date)) ; ?> </td>
                                                                ...
                                                                <td class="text text-right"><?php echo $value->trans_date; ?> </td>
