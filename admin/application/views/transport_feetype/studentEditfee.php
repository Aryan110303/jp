        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="box-body">
                    ...
                    <button type="button" class="btn cfees save_button" id="load" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $currency_symbol; ?> <?php echo 'Update Fees'; ?> </button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).on('click', '.save_button', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url("transportfee/editstudentfee") ?>',
            type: 'post',
            data: {date: date, type: feetype, amount: amount,student_fees_master_id: student_fees_master_id},
            dataType: 'json',
            success: function (response) {
                $this.button('reset');
...
<script type="text/javascript">
    $(".myCollectFeeBtn").click(function () {
        ...
        $.ajax({
            type: "post",
            url: '<?php echo site_url("transportfee/geBalanceFee_edit") ?>',
            dataType: 'JSON',
...
<script type="text/javascript">
    $(document).on('click', '.save_button_lst', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url("transportfee/editstudentfee_lst") ?>',
            type: 'post',
            data: {amount: amount,student_fees_master_id: student_fees_master_id},
            dataType: 'json',
            success: function (response) {
                $this.button('reset');
                if (response.status == "success") {
...
<div class="modal fade" id="myFeesModalbulk" role="dialog">
    <div class="modal-dialog">      
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title title text-center fees_title">Bulk Fees Update</h4>
            </div>
            <div class="modal-body pb0">
                <div class="form-horizontal">
                    <div class="box-body">
            ...
            <div class="modal-footer">
                <div class="box-body">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                    <button type="button" class="btn cfees save_button_lst" id="load" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $currency_symbol; ?> <?php echo 'Update Fees'; ?> </button>
                </div>
            </div>
        </div>
