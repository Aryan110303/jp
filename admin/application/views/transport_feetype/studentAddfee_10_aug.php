...
//                                        die;
                                        ...
                                        foreach ($fee->fees as $fee_key => $fee_value) {
                                            ...
                                            if($i == $len - 1){
                                            $total_amount = $total_amount + $fee_value->amount/2; }
                                            else{
                                            ...
                                            $total_fine_amount = $total_fine_amount + $fee_fine;
                                             if($i == $len - 1){
                                            $feetype_balance =  $fee_value->amount/2 - ($fee_paid + $fee_discount) ;
                                             }else
                                                {
                                            ...
                                            if ($feetype_balance > 0 && strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                ...
                                                <td align="left" class="text text-left">
                                                    ...
                                                    if ($fee_value->due_date == "0000-00-00") {
                                                        ...
                                                        echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($final = date("d-m-Y", strtotime("+".$i." month", strtotime($fee_value->due_date)))));//Change date  $final = date("d-m-Y", strtotime("+1 month", strtotime($fee_value->due_date)));
                                             ...
                                             <?php   if($i == $len - 1){ ?>   
                                                 <td class="text text-right"><?php echo $fee_value->amount/2; ?></td>
                                                 <?php }else{ ?>  
                                                ...
                                                <td>
                                                    <div class="btn-group pull-right"> 
                                                        <button type="button" data-student_fees_master_id="<?php echo $fee->id; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id; ?>" 
                                                                data-group="<?php echo $fee_value->route_title; ?>"
