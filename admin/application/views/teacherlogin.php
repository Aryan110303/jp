...
<html lang="en">
    <head>
        ...
        <title>J P ACADEMY | Teacher Login</title>
    ...
    $offset="col-md-offset-3";
                        ...
                        <div class="col-lg-5 col-sm-5 <?php echo $offset; ?> form-box">
                            <div class="loginbg">
                              <div class="form-top">
                                <div class="form-top-left">
                                    <img src="<?php echo base_url();?>backend/images/logo.png" class="logowidth">
                            ...
                            <div class="form-bottom">
                                <h3 class="font-white">Teacher Login</h3>
                                <?php
                                ...
                                ?>
                                <form action="<?php echo site_url('site/teacherlogin') ?>" method="post">
                                    <?php echo $this->customlib->getCSRF(); ?>
                                    <div class="form-group">
                                        <label class="sr-only" for="form-username">
                                            <?php echo $this->lang->line('phone'); ?></label>
                                        <input type="text" name="username" placeholder="<?php echo $this->lang->line('phone'); ?>" class="form-username form-control" id="email"> <span class="text-danger"><?php echo form_error('username'); ?></span>
                                    </div>
                                    <div class="form-group">                                        
