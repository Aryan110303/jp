                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                   ...
                                   <?php foreach ($departmentList as $depList) { ?>
                                      <li  ><?php echo $depList->department_name; ?>
                                           ...
                                           <?php $staff = $this->classteacher_model->get_data_by_query("SELECT * FROM staff where department ='".$depList->id."'  ORDER BY id DESC"); 
                                 ...
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="pwd">Message Type</label></br>
                                        <label for="pwd">Hindi
                                        <input type="checkbox" name="unicode" value="1"></label>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="textarea-compose" class="form-control" rows="6"><?php echo set_value('address'); ?>
                        ...
                        <form id="formedit" method="post" class="ptt10" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="pwd">Select Department</label>
                                        <?php /*?><select class="form-control select2" name="department[]" id="department" multiple="multiple">
                                            <option>Select Department</option>
                                            <?php
                                               foreach ($departmentList as $depList) {
                                                     echo "<option value=".$depList->id.">" .$depList->department_name. "</option>";
                                                 }  
                                            ?>
                                        </select><?php */?>
                                        <?php
