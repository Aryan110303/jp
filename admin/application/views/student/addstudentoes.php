                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('student/addstudentoes') ?>" method="post" class="">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active table-responsive no-padding" id="tab_1">
                              <form method="post" action="<?php echo base_url('student/updaterollno');?>" name="ateek_form"> 
                                <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty($resultlist)) {                                            ?>
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="rollno[]" value="<?php echo $student['roll_no']; ?>">
                                                     <input type="hidden" name="id[]" value="<?php echo $student['id']; ?>"></td>
                                                
                                                    <td><?php echo $student['class'] . "(" . $student['section'] . ")" ?></td>
                                                    <td><?php echo $student['father_name']; ?></td>
                                                    <td><?php echo $student['mother_name']; ?></td>
                                                    <td><?php  if($student["dob"] != null){ echo $student['dob'] ; }?></td>
                                        ...
                                        ?>
                                        <button type="submit"> update roll no.</button>
