                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="dob" name="dob" placeholder="" type="text" class="form-control"  value="<?php echo set_value('date of birth ',$student['dob'] ) ; ?>" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="admission_date" name="admission_date" placeholder="" type="text" class="form-control"  value="<?php echo set_value('admission_date', $student['admission_date']); ?>" readonly="readonly" />
                                     ...
                                     <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1"><?php echo 'Vehicles'; ?></label>
                                                             <select class="form-control" id="vehicles_id" name="vehicles_id" onchange="get_client_val(this.value)">
                                                                ...
                                                                <?php
                                                                        ...
                                                                        if (!empty($vehiclelist)) {
                                                                            foreach ($vehiclelist as $key => $value) {
                                                                                ?>
                                                                                <option value="<?php echo $value->id ?>" <?php if($value->id == $student["vehicle_id"]){ echo "selected" ; } ?> >
                                                                ...
                                                                if($student["vehicle_id"])
                                                                 ...
                                                                 ?>
                                                                        ...
                                                                        foreach ($routes as $row):
                                                                            ...
                                                                            if ($row['id'] == $student["route_id"]) {
                                                                                echo "selected";
                                                                            }
                                                                            ?> >
                                                                            <?php echo $row['route_title']; ?>
                                                                            </option>
                                                                        <?php endforeach; ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Fare<?php //echo $this->lang->line('bank_account_no'); ?></label>
                                                            <input id="fare" name="fare" placeholder="" type="text" class="form-control"  value="<?php echo set_value('fare', $student['transport_fees']); ?>" />
...
<script>
  function get_client_val(vehicle) {
        if(vehicle != '')
            $.ajax({
                url: '<?php echo base_url(); ?>student/get_route/' + vehicle,
                success: function(response)
                {
                    //console.log(response);
                    jQuery('#vehroute_id').html(response);
                }
            });
        else
            jQuery('#vehroute_id').html('<option value="">--Select Vehicle--</option>');
    }
        </script>
