...
<li class=""><a href="#uploadtc" data-toggle="tab" aria-expanded="true"><?php echo "Transfer Certificate" ?></a></li>
                                    ...
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody>  
                                            <tr>
                                                ...
                                                <td class="col-md-5">                                          
                                                    <?php if(!empty($student['admission_date'])) { echo $student['admission_date'];} ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo $this->lang->line('date_of_birth'); ?></td>
                                                <td><?php if(!empty($student['dob'])) { echo $student['dob']; } ?></td>
                                            </tr>
                                            <tr>
...
?>
                          ...
                          <div class="tab-pane" id="uploadtc">
                            <div class="timeline-header no-border">
                            
                                <button type="button"  data-student-session-id="<?php echo $student['student_session_id'] ?>" class="btn btn-xs btn-primary pull-right dltcbutton" id="dltcbutton"> <i class="fa fa-upload"></i>  <?php echo "Upload Transfer Certificate "; ?></button>
                                  <div class="table-responsive" style="clear: both;">
                                      <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        <th>
                                                        <?php echo "Download TC Here" ?>
                                                       </th>                                                      
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                              <?php
                                              //print_r($student['student_tc']); die;
                                              if (empty($student['student_tc'])) {
                                                  ?>
                                                    <tr>
                                                        <td colspan="5" class="text-danger text-center"><?php echo " No T.C. Generated" ; ?></td>
                                                    </tr>
                                              <?php
                                          } else {      ?>
                                                        <tr>
                                                            <td> <a type="button"  href="<?php echo base_url().$student['student_tc'] ?>" download class="btn btn-xs btn-primary "> <i class="fa fa-download"></i>  <?php echo "Download Transfer Certificate "; ?></a></td>                                                           
                                                        </tr>
                                                    <?php   }
                                                ?>
                                            </tbody>       
...
<script type="text/javascript">
     $("#dltcbutton").click(function () {
   // alert("pranav");
        var student_session_id = $(this).data("student-session-id");
        $('.TransferCertificate_title').html("<b>Upload Transfer Certificate (.pdf) File  </b>");
        $('#tc_student_session_id').val(student_session_id);
        $('#myTcModal').modal({
            backdrop: 'static',
            keyboard: false,
            show: true
...
<div class="modal fade" id="myTcModal" role="dialog">
    <div class="modal-dialog modal-sm400">      
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title title text-center TransferCertificate_title"></h4>
            </div>
            <div class="">
                <div class="">
                    <div class="">
                       
                        <form id="form1" action="<?php echo site_url('student/uploadtc') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                               <?php echo $this->customlib->getCSRF(); ?>
                            <div id='upload_documents_hide_show'>  
                              <input  type="hidden" class="form-control" id="tc_student_session_id"  value="0"  name="student_session_id" />
                                ...
                                <div class="col-md-12">                                          
                                            <div class="form-group">
                                                ...
                                                <div class="" style="margin-top:-5px; border:0; outline:none;">
                                                  <input id="first_doc_id" name="tc" placeholder="" type="file"  class="filestyle form-control" data-height="40"  value="<?php echo set_value('first_doc'); ?>" />
