                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('student/uploadExamResult') ?>" method="post" class="">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active table-responsive no-padding" id="tab_1">
                              <form method="post" action="<?php echo base_url('student/uploadmarksheet');?>" name="ateek_form" enctype="multipart/form-data"> 
                                        ...
                                        if (empty($resultlist)) {                                            ?>
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="file" name="fileToUpload_<?php echo $student['id']; ?>" class="filestyle form-control">
                                                        <input type="hidden" name="id[]" value="<?php echo $student['id']; ?>"></td>

                                                        <td><?php $chk = $this->db->query("SELECT id from frontmarksheet where student_id = '".$student['id']."'")->row();
                                                        if (!empty($chk->id)) {
