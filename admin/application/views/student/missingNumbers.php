            ...
            <div class="col-md-12">
                ...
                <div class="box box-info" style="padding:5px;">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo form_error('student'); ?> Missing Numbers Report</h3>
                    </div>
                    <div class="box-body table-responsive">
                        <div class="download_label"><?php echo $this->lang->line('guardian_report'); ?></div>
                                    ...
                                    foreach ($resultlist as $student) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right">
                                                <a  class="btn btn-warning btn-xs" onclick="setId(<?php echo $student['id']; ?>)"  data-toggle="modal" title="<?php echo $this->lang->line('edit'); ?>" data-target="#myModal">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title">Edit Guardian </h4> 
            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                        ...
                        <input type="hidden" name="stuId" id="stuId"/>
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="email"><?php echo 'Phone'; ?></label><small class="req"> *</small>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        $("#formadd").on('submit', (function (e) {
            e.preventDefault();
            $.ajax({
                url: "<?php echo site_url("student/missing_number_add") ?>",
                type: "POST",
