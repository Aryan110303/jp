...
// $route['student'] = 'student/unauthorized';
$route['admin/smslist'] = 'admin/smslist';
$route['admin/smslist/report'] ='admin/smslist/search_reports';
$route['admin/smslist/get_reports'] = 'admin/smslist/get_message_report';

$route['admin/smslist/(:any)'] = 'admin/site/smslist/$1';
...
//$route['api/Angular_api/cleardues'] = 'api/Angular_api/carryforwardedfees';
//$route['404_override'] = '';
