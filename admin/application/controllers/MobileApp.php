...
class MobileApp extends Admin_Controller {
    ...
    public function index(){
        ...
        $this->session->set_userdata('top_menu', 'Mobile');
        $this->session->set_userdata('sub_menu', 'Mobile');
        $data = $this->db->query('SELECT * from mobileappview where 1')->result():
        $this->load->view("layout/header");
        $this->load->view("mobileapp/mobileappview",$data);
