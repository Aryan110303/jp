...
//*********************************************************************************
            ...
            if (!empty($numbers)) {
                ...
                //print_r($other_number);die;
             }
             

			// if (!empty($departmentlisting)) { 
            //     foreach ($departmentlisting as $deplisting_key => $deplisting_value) {
            //             if($deplisting_value)
            //                 {
            ...
            // foreach ($section as $section_key => $section_value) {
                ...
                if (!empty($userlisting)) { foreach ($userlisting as $userlisting_key => $userlisting_value) {
                    ...
                    $data1 = array(
                            ...
                            'send_mail' => 0,
                            'send_sms' => 'sms',
                            'user_list' => $user_array.','.$other_number,
                            'sms_status' => 0,
							'type'=>2,
							'department' => 99,
...
//              print_r($userlisting);die;
	...
	function getStudentByClassandSection() {
		...
		$data = $this->student_model->searchByClassSection_complaint($class_id, $section_id);
