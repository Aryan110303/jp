                ...
                if (!empty($userlisting)) {
                    foreach ($userlisting as $userlisting_key => $userlisting_value) {
                        ...
                        $data1 = array(
                            ...
                            'send_mail' => 0,
                            'send_sms' => 'sms',
                            'user_list' => json_encode($array),
                            'sms_status' => 0,
                        );
                        $msgId = $this->messages_model->add($data1);
                        /*if (!empty($msgId)) {
                            if ($userlisting_value['mobileno'] != "") {

                                $this->smsgateway->sendSMS($userlisting_value['mobileno'], strip_tags($message));
                            }
                        }*/
                    }
                }
