...
//          print_r($row);die;
    ...
    function addfee($id) {
        ...
        $student_due_fee = $this->transport_custom_model->getStudenttransportFees($student['student_session_id']);
 ...
 function addfeegroup() {
    ...
    function geBalanceFee() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $result = $this->transport_custom_model->transportDeposit($data);
            $amount_balance = 0;
            $amount = 0;
            $amount_fine = 0;
            $amount_discount = 0;
...
//             $this->get_notify($notify_data);
    ...
    function printFeesByGroup() {
        ...
        $setting_result = $this->setting_model->get();
        $data['settinglist'] = $setting_result;
        $data['feeList'] = $this->transport_custom_model->getDueFeeByFeeSessionGroupFeetype1($fee_session_group_id, $fee_master_id, $fee_groups_feetype_id);
    ...
    public function send_mail() { 
         $from_email = "lksjbp@lksjbp.com"; 
         $to_email = 'logann.thakur@gmail.com'; 
