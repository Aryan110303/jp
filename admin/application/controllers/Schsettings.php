...
class Schsettings extends Admin_Controller {
    ...
    function ajax_schedit() {
        ...
        $this->form_validation->set_rules('fee_due_days', 'Fees Due Days', 'trim|required|xss_clean');//fine_amount
        $this->form_validation->set_rules('fine_amount', 'Fees Amount', 'trim|required|xss_clean');//
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                ...
                'fee_due_days' => $this->input->post('fee_due_days'),//fine_amount
