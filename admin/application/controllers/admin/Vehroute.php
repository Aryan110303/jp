...
//            $this->vehroute_model->add($vehicle_batch_array);
            ...
            $vehicle = $this->input->post('vehicle');
            $route_id = $this->input->post('route_id');
            $route_batch_array = array();
            foreach ($route_id as $vec_key => $vec_value) {
                ...
                $route_batch_array[] = $route_array;
            }
            $this->vehroute_model->add($route_batch_array);
            //**********************************************
    ...
    function delete($id) {
        ...
        $this->vehroute_model->removeByvehicle($id);
