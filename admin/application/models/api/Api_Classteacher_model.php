...
class Api_Classteacher_model extends CI_Model {
    ...
    public function findfield($table,$fieldname1,$fieldvalue1,$returnfield)
		...
		public function check_classTeacher($class, $section, $teacher_id,$current_session){
        ...
        $query = $this->db->get('class_teacher_2');
